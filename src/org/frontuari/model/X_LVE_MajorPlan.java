...
/** Generated Model for LVE_MajorPlan
 *  @author iDempiere (generated) 
 *  @version Release 4.1 - $Id$ */
public class X_LVE_MajorPlan extends PO implements I_LVE_MajorPlan, I_Persistent 
{
...
// @#Date@
    ...
    /** Load Constructor */
    public X_LVE_MajorPlan (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_LVE_MajorPlan[")
	...
	public void setLVE_MajorPlanType_ID (int LVE_MajorPlanType_ID)
	{
		if (LVE_MajorPlanType_ID < 1) 
			set_Value (COLUMNNAME_LVE_MajorPlanType_ID, null);
		else 
			set_Value (COLUMNNAME_LVE_MajorPlanType_ID, Integer.valueOf(LVE_MajorPlanType_ID));
	}
	...
	/** Set LVE_MajorPlan_UU.
		@param LVE_MajorPlan_UU LVE_MajorPlan_UU	  */
	public void setLVE_MajorPlan_UU (String LVE_MajorPlan_UU)
	{
		set_ValueNoCheck (COLUMNNAME_LVE_MajorPlan_UU, LVE_MajorPlan_UU);
	}

	/** Get LVE_MajorPlan_UU.
		@return LVE_MajorPlan_UU	  */
	public String getLVE_MajorPlan_UU () 
	{
		return (String)get_Value(COLUMNNAME_LVE_MajorPlan_UU);
	}
